...
const schema = yup.object().shape({
  ...
  password: yup.string().min(6, 'Vui lòng nhập ít nhất 6 kí tự').max(15, 'Vui lòng không nhập quá 15 kí tự').required("Vui lòng nhập mật khẩu hơp lệ"),
  confirmPassword: yup.string().oneOf([yup.ref("password"), null]).required("Vui lòng nhập lại mật khẩu"),
  username: yup.string().required("Vui lòng nhập tên người dùng"),
  phone: yup.string().min(10, 'Vui lòng nhập số điện thoại hợp lệ').required("Vui lòng nhập số điện thoại"),
...
const SignUp = () => {
  ...
  const handleSignUp = async (data) => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: error.response.data.message||"email này đã tồn tại",
      });
  ...
  return (
    <div
      className="h-screen overflow-y-scroll flex items-center justify-center"
